import { VehicleSpecs } from './src/models/inventory-v4/vehicle/vehicle-specs.model';
import { TeslaService } from './src/services/tesla.service';
import { TeslaInventoryQuery } from './src/models/inventory-v4/inventory-query.model';
import * as Model from './src/constants/models.const';
import * as ArrangeBy from './src/constants/arrange-by-options.const';
import * as Condition from './src/constants/conditions.const';
import * as Order from './src/constants/ordering.const';
import * as Market from './src/constants/markets.const';
import * as Region from './src/constants/regions.const';
